...
from testcase_template import *  #replace the word template with the name of your test

def main():

    testcase = "testcase1" #replace with a testcase name
    ...
    parser.add_option("-t", "--testcase", dest="testcase", help="testcase1") #add all your testcase names here
    ...
    ui =testcase_template(testcase) #replace testcase_template with the name of your test
