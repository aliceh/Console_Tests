...
from testcase_security_group import *
...
def main():
	...
	parser.add_option("-t", "--testcase", dest="testcase", help="testcase: create_security_group, delete_security_group, create_s_group_churn")
